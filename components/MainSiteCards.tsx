...
export default function MainSiteCards() {
  return (<section>
    <h2 className="mt-64 text-4xl text-center tracking-tight font-bold text-gray-900 sm:text-5xl md:text-4xl">
      ...
      <div className="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 justify-items-stretch gap-8 mt-4 md:grid-cols-2 lg:grid-cols-3">
          <a className="block p-8 transition border border-gray-400 shadow-xl rounded-xl hover:shadow-indigo-500/20 hover:border-indigo-500" href="/services/digital-campaigns">
            ...
            <h3 className="mt-4 text-xl font-bold">Przeglądy okresowe</h3>
          ...
          <a className="block p-8 transition border border-gray-400 shadow-xl rounded-xl hover:shadow-indigo-500/20 hover:border-indigo-500" href="/services/digital-campaigns">
            ...
            <h3 className="mt-4 text-xl font-bold">Pielęgnacja i konserwacja</h3>
